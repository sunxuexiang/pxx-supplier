 ...
 * @returns {Promise<IAsyncResult<TList>>}
 */
export const purchaseDele = (params) => {
  return Fetch('/supplier/purchase', {
    method: 'DELETE',
    body: JSON.stringify({
      ...params
    })
 ...
 */
export const discountPrefinfo = (trade) => {
  const request = {
    method: 'POST',
    body: JSON.stringify(trade)
  };
  return Fetch<TResult>('/trade/importGoodsInfos/getMarketing', request);
};
 ...
 * @returns {Promise<IAsyncResult<T>>}
 */
export const mactchWareHouse = (params) => {
  return Fetch('/warehouse/match-ware-house-for-supplier', {
    method: 'POST',
    body: JSON.stringify({
      ...params
    })
 ...
 * @returns {Promise<IAsyncResult<TList>>}
 */
export const checkDeliveryHomeFlag = (params) => {
  const request = {
    method: 'POST',
    body: JSON.stringify({
      ...params
  ...
  return Fetch<TResult>('/trade/checkDeliveryHomeFlagOne', request);
};
 ...
 * @returns {Promise<IAsyncResult<TList>>}
 */
export const logisticscompany = (urlType = 0) => {
  const request = {
    method: 'POST',
    body: JSON.stringify({
      logisticsName: ''
