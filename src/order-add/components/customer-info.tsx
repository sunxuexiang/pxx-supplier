            ...
            <FormItem label="收货信息" hasFeedback {...formItemLayout}>
              {
                <Radio.Group
                  ...
                  onChange={(e: any) => {
                    ...
                    // console.log(addrId);
                    sessionStorage.setItem('selectedAddrId', addrId);
                    clearOrder();
                    let obj = {
                      wareId: 1,
                      pickUpFlag: 0
                    ...
                    this.props.relaxProps.clearAddress();
                    this.setState({
                      selectedAddrId: addrId
                    });
                    setSecletWareHouse(fromJS(obj));
                  }}
                >
                  {addrs.map((v, k) =>
                    showType === 2 || k < 10 ? (
