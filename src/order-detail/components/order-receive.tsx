...
import { Table, Tooltip, Menu, Popover, Avatar } from 'antd';
import { noop, Const, util, ImgPreview } from 'qmkit';
...
export default class OrderReceive extends React.Component<any, any> {
  ...
  render() {
    const { openPreview, imgPreviewList } = this.state;
    ...
    return (
      <div style={styles.container}>
        ...
        <div>
          <Table
            columns={this.getColumns(payRecord.toJS())}
