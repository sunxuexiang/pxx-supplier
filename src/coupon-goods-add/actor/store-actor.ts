  ...
  defaultState() {
    return {
      ...
      activity: {
        ...
        activityName: '',
        //活动标题
        activityTitle: '指定商品赠券',
        //活动描述
        activityDesc: '购买指定商品赠券',
        // 仓库id {/* 商家入驻需求  默认值 -1（通用）原来为1 */}
        wareId: '-1',
        // 开始时间
        startTime: '',
        // 结束时间
