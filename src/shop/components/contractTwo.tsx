...
export default class ContractTwo extends React.Component {
  props: {
    form;
    contractInfo: IMap;
  };
  render() {
    ...
    return (
      <div>
        <article className="shop-contract-title-left">附件5-2：</article>
        <article className="shop-contract-title">
          中国建设银行“惠市宝—对公专业结算综合服务平台”加入申请书
        </article>
        <article className="shop-contract-center">（企事业单位版）</article>
        ...
        <article className="shop-contract-bold">
          1.我单位自愿加入该平台，并已知悉并同意业务合作协议以及为实现惠市宝产品及服务已经及/或将要签署的具体协议（包括但不限于业务合作协议附件、各类客户服务协议、系统使用协议、产品使用协议、业务协议以及其他相关的法律性文件及其不时修订）的全部内容，对全部条款的含义及相应的法律后果已全部通晓并充分理解，同意以签署本申请书的方式加入该平台，我单位承诺遵守业务合作协议、具体协议等惠市宝相关协议及本申请书的全部要求。
        </article>
        <article>
          2.我单位确保向贵行提供的所有证件、资料均合法、真实、准确、完整和有效。
        </article>
        <article>
          3.我单位确保通过该平台所发生的营业资金具有真实交易背景，确保经营行为合法、合规。承诺在本申请书有效期内不存在任何违反有关支付结算、现金管理业务等相关法律、法规和规章的行为或情形，不参与洗钱、套取现金、传销、逃避自身债务、刷单、违反国际金融制裁及任何其它违法违规行为。
        </article>
        <article className="shop-contract-bold">
          4.
          本申请书是我单位的真实意思表示，符合法律、行政法规、规章和我单位章程或内部组织文件的规定，且已获得我方内部有权机构及/或国家有权机关的批准。我方确保与贵行进行业务往来并签约本申请书的经办人具有相应的权限。因我单位无权与贵行进行业务往来或签署相关协议而产生的一切责任均由我单位承担，包括但不限于全额赔偿贵行因此遭受的损失。
        </article>
        <article>
          5.我单位同意并不可撤销地授权：贵行按照国家相关规定采集并向金融信用信息基础数据库及其他依法成立的征信机构提供我单位及我方法定代表人（负责人）信息和包括信贷信息在内的信用信息（包含我方及我方法定代表人（负责人）因未及时履行合同义务产生的不良信息）；在办理涉及我方的业务时，有权向金融信用信息基础数据库及其他依法成立的征信机构查询、打印、保存我单位及我单位法定代表人（负责人）的信用信息，用于“惠市宝—对公专业结算综合服务平台”相关服务的提供。若涉及我单位在贵行业务未获批准办理，本授权书及我单位信用报告等资料无须退回我方。
        </article>
        <article>
          6.我单位参与“惠市宝—对公专业结算综合服务平台”并用于营业资金收款分账的账户信息如下：
        </article>
        <article>
          户名：
          <Form.Item>
        ...
        <article>
          ...
          <span className="shop-contract-bold">
            上述信息真实有效，因上述信息不完整、不真实或不及时等非归责于贵行的原因而产生的一切责任由我单位承担。
          </span>
        </article>
        <article>
          7.
          我单位同意自贵行收到我方提交的本申请书并在惠市宝平台或系统中确认之日起，我方及或前述指定账户正式加入“惠市宝—对公专业结算综合服务平台”。
        </article>
        <article>
          8.我单位同意贵行根据惠市宝相关协议中的《中国建设银行网络特约商户及网络支付业务合作协议》的约定，按照交易结算金额的一定比例向我单位或向
          <span className="shop-contract-underline">
            湖南喜吖吖商业服务有限公司
          </span>
        ...
        <article className="shop-contract-bold">
          9.如有违反业务合作协议、具体协议等惠市宝相关协议或本申请书承诺事项，我单位同意贵行有权单方面停止任一及/或全部惠市宝产品及服务，并解除“惠市宝—对公专业结算综合服务平台”签约关系。如因我单位自身原因或因我单位违背业务合作协议、具体协议等惠市宝相关协议或本申请书承诺导致的损失，与贵行无关，由我单位承担全部责任。
        </article>
        <article>
          10.我单位同意贵行按有权按照司法机关要求执行查询、冻结、扣划操作，不对此提出异议。
        </article>
        <article className="shop-contract-bold">
          11.我单位同意
          <span className="shop-contract-underline">
        ...
        <article className="shop-contract-bold">
          ...
          平台或系统中所使用的电子签名方式为符合各方约定的可靠的电子签名方式；我单位登入贵行
          <span className="shop-contract-underline">喜吖吖惠市宝</span>
          平台或系统的方式为我单位认可的身份认证方式，凡通过该身份认证方式后的操作均视为我单位（或其授权代理人）所为，我单位承诺对由此产生的法律后果承担责任。
        </article>
        <article>
          该申请有效期：本申请书签署日期到
          <span className="shop-contract-underline">
        ...
        <article>
          我单位授权
          <Form.Item>
            {getFieldDecorator('unitAuthorization', {
              initialValue: contractInfo.get('unitAuthorization'),
              rules: [{ required: true, message: '请填写' }]
        ...
        <article>
          我单位已充分了解业务合作协议、具体协议等惠市宝相关协议和本申请书的内容，对惠市宝相关协议和前述申请及承诺事项的真实性、合法性及有效性已进行必要审查，同时连带承担由此产生的一切责任。
        </article>
        <article className="shop-contract-bold">
          如采用线上方式签署，则我单位具体签署方式为
          <span className="shop-contract-underline">线上法大大</span>
          我单位确认在
          <span className="shop-contract-underline">法大大</span>
          平台或系统中所使用的电子签名方式为符合各方约定的可靠的电子签名方式；我单位登入贵行
