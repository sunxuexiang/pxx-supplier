...
export default class ListActor extends Actor {
  ...
  refundOnlineModalChange(state: IMap, modalStatus: IMap) {
    return state
      ...
      .setIn(['onlineRefundModalData', 'mergFlag'], modalStatus.get('mergFlag'))
      ...
      .setIn(
        ['onlineRefundModalData', 'modifyPrice'],
        modalStatus.get('modifyPrice')
      )
      .setIn(
        ['onlineRefundModalData', 'modifyComment'],
        modalStatus.get('modifyComment')
      );
  }
  ...
  refundModalChange(state: IMap, modalStatus: IMap) {
    return state
      ...
      .setIn(['refundModalData', 'mergFlag'], modalStatus.get('mergFlag'))
      ...
      .setIn(
        ['refundModalData', 'modifyPrice'],
        modalStatus.get('modifyPrice')
      )
      .setIn(
        ['refundModalData', 'modifyComment'],
        modalStatus.get('modifyComment')
      );
  }
