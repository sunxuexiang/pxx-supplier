...
export default class CateList extends React.Component<any, any> {
  ...
  render() {
    ...
    let hasMenu = false;
    if (
      checkAuth('f_goods_sku_edit_2-ls') ||
      checkAuth('f_goods_sku_edit_3-ls') ||
  ...
  _menu = (rowInfo) => {
    ...
    return (
      <div className="operation-box">
        {rowInfo.goodsType == 2 && (
          <AuthWrapper functionName="f_goods_sku_edit_price-ls">
            <a
        ...
        {rowInfo.goodsType != 2 && (
          <AuthWrapper functionName="f_goods_sku_edit_2-ls">
            <a
              href="javascript:;"
              onClick={() => {
                // let request: any = {
                ...
                history.push({
                  pathname: `/ls_goods-edit/${rowInfo.goodsId}/${pageNum}`,
                  state: { tab: 'main' }
                });
              }}
            >
            ...
            <div style={{ marginLeft: 17 }}>
              ...
              <AuthWrapper functionName="f_goods_sku_edit_2-ls">
                <a
                  ...
                  onClick={() =>
                    history.push({
                      pathname: `/ls_goods-sku-edit/${goods.get(
                        'goodsInfoId'
                      )}`,
                      state: { tab: 'main' }
                    })
