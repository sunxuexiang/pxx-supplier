...
export const syncGoodsWareStock = (param: any) => {
  return Fetch('/goods/ware/stock/syncStock', {
    method: 'POST',
...
export const syncErpGoodsWareStock = (param: any) => {
  return Fetch('/goods/ware/stock/syncStockNew', {
    method: 'POST',
    body: JSON.stringify(param)
  });
};
...
export const exportMarketing = (params) => {
  return Fetch<TResult>('/store/uploadStoreResource?resourceType=IMAGE', {
    method: 'POST',
    body: JSON.stringify(params),
    headers: {
  ...
  // return fetch(Const.HOST + '/store/uploadStoreResource?resourceType=IMAGE', {
  //   method: 'POST',
  //   credentials: 'include',
  //   headers: {
