...
export const getGoodsDetail = (goodsId: string) => {
  return Fetch(`/bulk/goods/spu/${goodsId}`);
};
...
export const syncGoodsWareStock = (param: any) => {
  return Fetch('/bulk/goods/ware/stock/syncStock', {
    method: 'POST',
...
export const syncErpGoodsWareStock = (param: any) => {
  return Fetch('/bulk/goods/ware/stock/syncStockNew', {
    method: 'POST',
    body: JSON.stringify(param)
  });
};
...
export const addAll = (param: any) => {
  return Fetch('/bulk/goods/spu/price', {
    method: 'POST',
    body: JSON.stringify(param)
  });
};
...
export const addBrand = (formData: IMap) => {
  return Fetch('/bulk/goods/goodsBrand', {
    method: 'POST',
    body: JSON.stringify({
...
export const toGeneralgoods = (goodsId: String) => {
  return Fetch(`/bulk/goods/distribution-change/${goodsId}`, {
    method: 'PATCH'
  });
};
...
export const checkEnterpriseType = (goodsId: String) => {
  return Fetch<TResult>('/enterprise/bulk/enterprise-check', {
    method: 'POST',
...
export const enterpriseToGeneralgoods = (goodsId: String) => {
  return Fetch('/bulk/enterprise/batchDelete', {
    method: 'POST',
    body: JSON.stringify({ goodsId: goodsId })
  });
};
