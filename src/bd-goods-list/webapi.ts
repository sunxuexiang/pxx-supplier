...
const goodsList = (params) => {
  ...
  return Fetch<TResult>('/bulk/goods/spus', request);
};
...
const spuDelete = (params: { goodsIds: string[] }) => {
  ...
  return Fetch('/bulk/goods/spu', request);
};
...
const spuOnSale = (params: { goodsIds: string[] }) => {
  ...
  return Fetch('/bulk/goods/spu/sale', request);
};
...
const goodsFreight = (freightTempId) => {
  return Fetch<TResult>(
    `/bulk/freightTemplate/freightTemplateGoods/${freightTempId}`
  );
};
...
const goodsFreightExpress = (freightTempId) => {
  return Fetch<TResult>(
    `/bulk/freightTemplate/freightTemplateExpress/${freightTempId}`
  );
};
...
const updateFreight = (params) => {
  ...
  return Fetch('/bulk/goods/spu/freight', request);
};
...
const setGoodsSeqNum = (params) => {
  ...
  return Fetch('/bulk/goods/spu/modifySeqNum', request);
};
/**
 * 查询品牌关联
 */
const searchBrandLink = (brandId) => {
  return Fetch<TResult>(`/bulk/goods/goodsBrand/${brandId}`);
};
...
const setGoodPrice = (params) => {
  return Fetch<TResult>('/bulk/goods/special-setGoodPrice', {
    method: 'POST',
    body: JSON.stringify(params)
  });
};
...
const synchronizeSpecialGoods = () => {
  return Fetch<TResult>('/bulk/goods/syn/special', {
    method: 'GET'
  });
};
...
const batchCate = (params) => {
  return Fetch<TResult>('/bulk/goods/spu/cate/batch', {
    method: 'PUT',
    body: JSON.stringify(params)
  });
};
