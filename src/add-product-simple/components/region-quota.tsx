...
const RegionQuota = forwardRef((props: any, ref) => {
  ...
  useEffect(() => {
    if (props.openEdit) {
      ...
      setInfo({ ...data });
      setAllowedPurchaseAreaName(data.allowedPurchaseAreaName);
      setSingleOrderAssignAreaName(data.singleOrderAssignAreaName);
  ...
  return (
    <div className="new-product-card" style={{ display: 'none' }}>
