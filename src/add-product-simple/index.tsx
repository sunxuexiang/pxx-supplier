...
import { Const, BreadCrumb, util, history } from 'qmkit';

export default function AddProductSimple(props) {
    ...
    if (
      ...
      const goodsInfo = attrData.goodsInfos.map((item) => {
        return {
          ...
          dateUnit: baseInfoData.dateUnit,
          ...
          goodsInfoImg: baseInfoData.images[0].artworkUrl
        };
      });
      const data = {
        goods: {
