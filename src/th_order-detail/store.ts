...
import { addPay, fetchLogistics, fetchOrderDetail, payRecord,pickTrades } from './webapi';
  ...
  init = async (tid: string) => {
    ...
    if (code == Const.SUCCESS_CODE) {
      ...
      this.transaction(() => {
        ...
        this.dispatch(
          'receive-record-actor:init',[payRecordResult.res.context]
        ...
        this.dispatch('tradesList:init',fromJS(pickTradesResult.res.context?.pickOrderItems||[]));
