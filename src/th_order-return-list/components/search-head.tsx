...
export default class SearchHead extends Component<any, any> {
  ...
  render() {
    ...
    let hasMenu =
      (tabKey == 'flowState-INIT' && checkAuth('drolf002')) ||
      (tabKey == 'flowState-DELIVERED' && checkAuth('drolf004')) ||
      checkAuth('drolf006');
    const batchMenu = (
      <Menu>
        ...
        {/* {tabKey == 'flowState-DELIVERED' ? (
          <Menu.Item>
            <AuthWrapper functionName="drolf004">
        ...
        <Menu.Item>
          <AuthWrapper functionName="drolf006">
          ...
          <Form className="filter-content" layout="inline">
            ...
            <FormItem>
              <Input
                ...
                onChange={(e) => {
                  this.setState(
                    { employeeName: (e.target as any).value },
                    this._paramChanged
                  );
                }}
              />
