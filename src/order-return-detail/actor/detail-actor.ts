...
export default class DetailActor extends Actor {
  ...
  refundModalChange(state: IMap, modalStatus: IMap) {
    return state
      ...
      .setIn(['refundModalData', 'modifyPrice'], modalStatus.get('modifyPrice'))
      .setIn(['refundModalData', 'modifyComment'], modalStatus.get('modifyComment'))
  }
  ...
  refundOnlineModalChange(state: IMap, modalStatus: IMap) {
    return state
      ...
      .setIn(['onlineRefundModalData', 'modifyPrice'], modalStatus.get('modifyPrice'))
      .setIn(['onlineRefundModalData', 'modifyComment'], modalStatus.get('modifyComment'))
  }
