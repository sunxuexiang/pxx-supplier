  ...
  render() {
    ...
    const shouldPrice = tradeDetail
      ...
      .map((sku) => {
        ...
        // if (sku.get('num') < sku.get('totalNum')) {
        //   //小于可退数量,直接单价乘以数量
        //   return QMFloat.accMul(sku.get('price'), sku.get('num'));
        // } else {
        //   console.log('大于等于可退数量 , 使用分摊小计金额 - 已退金额(单价*(购买数量-可退数量))');
    ...
    // console.log(shouldPrice.toJS(),'shouldPrice');
    // console.log(tradeDetail
    //   .get('tradeItems').toJS(),'2222')
    ...
    console.log('applyStatus-------------', shouldPrice);
    return (
