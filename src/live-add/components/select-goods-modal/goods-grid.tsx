        ...
        <DataGrid
          ...
          rowSelection={{
            ...
            onChange: (selectedRowKeys: any[], selectedTableRows: any[]) => {
              ...
              rowChangeBackFun(selectedRowKeys, fromJS(rows), goodsInfoList);
            }
          }}
        >
          <Column
          ...
          <Column
            ...
            render={(row, rowInfo) => {
              ...
              switch (rowInfo.priceType) {
                case 1:
                  comps = [<div key={rowInfo.goodsId}>￥{rowInfo.price}</div>];
                  break;
                case 2:
                  comps = [
                    <div key={rowInfo.goodsId}>
                ...
                case 3:
                  ...
                  break;
                default:
                  comps = [<div key={rowInfo.goodsId}>--</div>];
                  break;
              }
              return comps;
            }}
  ...
  init = async (params) => {
    ...
    if ((res as any).code == Const.SUCCESS_CODE) {
      ...
      this.setState({
        ...
        goodsInfoList: res['goodsInfoList'],
        loading: false
      });
    }
  };
